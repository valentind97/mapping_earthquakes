...
let airportData = 'https://raw.githubusercontent.com/krmcclelland/Mapping_Earthquakes/main/majorAirports.json';
...
L.geoJSON(data,{
  onEachFeature: function(feature, layer) {
    console.log(layer);
    layer.bindPopup("<h3>" + "Airport Code: " + feature.properties.faa + "</h3><hr><p>" + feature.properties.name + "</p>");
  }    
}).addTo(map);
});